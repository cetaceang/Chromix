...
def load_pins(repo: Path, platform: str) -> dict:
    ...
    for key in ("UngoogledVersion", platform_fields[0]):
        value = pins[key]
    ...
    if pins[platform_fields[0]] != core and not pins[platform_fields[0]].startswith(core + "."):
