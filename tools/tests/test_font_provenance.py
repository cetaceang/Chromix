...
def test_independent_patch_roundtrip(tmp_path, version, sha256):
    ...
    # Pinned 153 inserts three unrelated lines before the final three hunks.
    apply(tmp_path, patch_path("0152"), allow_offsets=version == "153")
    apply(tmp_path, patch_path("0152"), reverse=True, allow_offsets=version == "153")
